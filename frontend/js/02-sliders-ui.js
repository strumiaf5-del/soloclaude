...
(function () {
  'use strict';
      ...
      // Bootstrap: pinta el valor inicial de cada slider que aún no migró a
      // data-display-target (los updates en vivo los maneja LG.ui.syncRangeDisplay
      // para los inputs declarativos — ver 00-ui-core.js:46-51).
